import { fazerLogin } from "../../lib/firebase"; /*importei aqui a função fazerLogin do arquivo localizado em firebase.js ????*/
...
export function login() {
   ...
   <main>
     ...
     <section class="formulario">
      ...
      <input type = "text" class="login" id="email-login" name="login" placeholder = "" requered>
      <!--mudei o type ="login" para type="email"-->
...
const loginPage= document.createElement("link");
loginPage.rel = "stylesheet"; 
